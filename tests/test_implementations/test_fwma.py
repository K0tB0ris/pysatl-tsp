...
def calculate_pandas_ta_classic_fwma(data: list[float], length: int, asc: bool) -> list[float | None]:
...
def test_fwma_basic() -> None:
    ...
    pandas_result = calculate_pandas_ta_classic_fwma(data, length, asc)
...
def test_fwma_property_based(data: list[float], length: int) -> None:
    pandas_result = calculate_pandas_ta_classic_fwma(data, length, True)
